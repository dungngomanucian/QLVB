...
if (noCopy) {
    ...
    document.body.ON - COPY = function() { return false };

    document.body.ON - CON - TEXTMENU = function() { return false };

    document.body.onselectstart = document.body.ON - DRAG = function() {

        return false;

    }

    document.ON - KEY - DOWN = function() {
