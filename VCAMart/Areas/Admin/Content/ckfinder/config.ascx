...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        // BaseDir = HttpContext.Current.Server.MapPath("~/Images/" + thumuc + "/");
          BaseUrl = "~/Images/" + System.Web.HttpContext.Current.Session["user_uid"] + "/"; // "/Images/";
          BaseDir = HttpContext.Current.Server.MapPath("~/Images/" + System.Web.HttpContext.Current.Session["user_uid"] + "/");
