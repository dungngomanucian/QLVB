...
namespace RICTotalAdmin.Controllers
{
    public class BannerController:Controller
    {
        ...
        BannerModel mdl = new BannerModel();
        ...
        public BannerController()
        {
            msg = "";
            tblname = "tblBanner";
            ViewBag.Function_Title = "DANH SÁCH ẢNH BANNER";
            ViewBag.Function_Title_Short = "Banner";
        ...
        public ActionResult Index(string id)
        {
            ...
            ViewBag.Function_Title = "DANH SÁCH ẢNH BANNER";
            ViewBag.Function_Title_Short = "Banner";
            return View("~/Areas/Admin/Views/Banner/Index.cshtml");
        }
        public void ChangeLanguage()
        {
            langId = System.Web.HttpContext.Current.Session["lglang_id_id"].ToString();
            if (langId == "2")
            {
                ViewBag.lang_text = "Vietnamese";
                ViewBag.lang_link = "/Admin/Home/ChangeLanguage/1";
