...
namespace RICTotalAdmin.Controllers
{
    public class TinhTPController:Controller
    {
        ...
        TinhTPModel mdl = new TinhTPModel();
        ...
        {
            msg = "";
            tblname = "tblProvinces";
            ViewBag.Function_Title = "DANH SÁCH TỈNH/TP";
            ViewBag.Function_Title_Short = "Tinh/TP";
        ...
        public ActionResult Index(string id)
        {
            ...
            ViewBag.mn_tt = id;
            ViewBag.Function_Title = "THÔNG TIN TỈNH/TP";
            ViewBag.Function_Title_Short = "Part";
            return View("~/Areas/Admin/Views/TinhTP/Index.cshtml");
        }
        ...
        bool IsValid(ref dynamic data, bool bAdd = true)
        {
            ...
            if (data.DT_Code == "") kt = false;
            if (data.DT_Name == "") kt = false;
            return kt;
        }
