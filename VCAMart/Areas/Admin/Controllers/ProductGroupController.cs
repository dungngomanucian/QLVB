...
namespace RICTotalAdmin.Controllers
{
    public class ProductGroupController:Controller
    {
        ...
        ProductGroupModel mdl = new ProductGroupModel();
        ...
        {
            msg = "";
            tblname = "tblProductGroup";
            ViewBag.Function_Title = "DANH MỤC NHÓM SẢN PHẨM";
            ViewBag.Function_Title_Short = "ProductGroup";
        ...
        public ActionResult Index(string id)
        {
            ...
            ViewBag.Function_Title = "DANH MỤC NHÓM SẢN PHẨM";
            ViewBag.Function_Title_Short = "ProductGroup";
            return View("~/Areas/Admin/Views/ProductGroup/Index.cshtml");
        }
