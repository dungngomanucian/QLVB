...
namespace RICTotalAdmin.Controllers
{
    public class ChucVuController:Controller
    {
        ...
        ChucVuModel mdl = new ChucVuModel();
        ...
        public ChucVuController()
        {
            msg = "";
            tblname = "tblChucVu";
            ViewBag.Function_Title = "DANH SÁCH CHỨC VỤ";
            ViewBag.Function_Title_Short = "ChucVu";
        ...
        public ActionResult Index(string id)
        {
         /*  if (!common.checkQuyenSudung(mdl.userId.ToString(), this.GetType().Name.Replace("Controller", ""), ref msg))
            ...
            ViewBag.Function_Title = "DANH MỤC CHỨC VỤ";
            ViewBag.Function_Title_Short = "Chuc vu";
            return View("~/Areas/Admin/Views/ChucVu/Index.cshtml");
        ...
        bool IsValid(ref dynamic data, bool bAdd = true)
        {
            ...
            if (data.CV_CQL_Id == "00000000-0000-0000-0000-000000000000")
                kt = false;
            if (data.CV_Code == "") kt = false;
            if (data.CV_Name == "") kt = false;
            return kt;
        }
