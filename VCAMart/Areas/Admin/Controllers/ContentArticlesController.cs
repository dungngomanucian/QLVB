...
namespace RICTotalAdmin.Controllers
{
    ...
    public class ContentArticlesController:Controller
    {
        ...
        ContentArticlesModel mdl = new ContentArticlesModel();
        ...
        public ContentArticlesController()
        {
            msg = "";
            tblname = "tblContentArticles";
            ViewBag.Function_Title = "DANH MỤC BÀI VIẾT";
        ...
        public ActionResult Index(string id)
        {
            ...
            ViewBag.Function_Title = "DANH MỤC BÀI VIẾT";
            ViewBag.Function_Title_Short = "TinTuc";
            return View("~/Areas/Admin/Views/ContentArticles/Index.cshtml");
        }
        ...
        public ActionResult ListParent()
        {
            ...
            var data = mdl.BuildTreeDropdown(nodes, ContentArticlesModel.ROOT_ID);
