...
{
    public class PermissionMemberController:Controller
    {
        string msg = "";
        public string tblname;
        jsonClientPost jc;
        PermissionMemberModel mdl = new PermissionMemberModel();

        public PermissionMemberController()
        {
            tblname = "tblNhomquyen";
            ViewBag.Function_Title = "Phân quyền cho user";
            ViewBag.Function_Title_Short = "Permission of member";
        ...
        public ActionResult Index(string id)
        {
            ...
            ViewBag.Function_Title = "Phân quyền cho user";
            ViewBag.Function_Title_Short = "Permission of member";
            return View("~/Areas/Admin/Views/PermissionMember/Index.cshtml");
        }
