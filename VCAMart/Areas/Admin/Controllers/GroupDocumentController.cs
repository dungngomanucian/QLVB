...
namespace RICTotalAdmin.Controllers
{
    public class GroupDocumentController:Controller
    {
        ...
        GroupDocumentModel mdl = new GroupDocumentModel();
        ...
        public GroupDocumentController()
        {
            msg = "";
            tblname = "tblGroupDocument";
            ViewBag.Function_Title = "DANH SÁCH NHÓM TÀI LIỆU";
            ViewBag.Function_Title_Short = "Group-Document";
        ...
        public ActionResult Index(string id)
        {
            ...
            ViewBag.Function_Title = "DANH SÁCH NHÓM TÀI LIỆU";
            ViewBag.Function_Title_Short = "Group-Document";
            return View("~/Areas/Admin/Views/GroupDocument/Index.cshtml");
        ...
        public ActionResult ImportJsonToDatabase(string data, string uid, string id)
        {
            ...
            if (!checkValidForImport(ref row))
            {
                jc.code = 101;
                jc.msg = msg;
        ...
        bool checkValidForImport(ref dynamic data, bool bAdd = true)
        {
            bool kt = true;
            string uid = ViewBag.login_nv_id.ToString();
            if (data.LoaiHinh == "0") kt = false;
        ...
        bool IsValid(ref dynamic data, bool bAdd = true)
        {
            ...
            if (data.group_code == "0") kt = false;
            if (data.group_title == "0") kt = false;
            return kt;
        }
