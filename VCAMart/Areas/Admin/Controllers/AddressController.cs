...
namespace RICTotalAdmin.Controllers
{
    ...
    public class AddressController:Controller
    {
        ...
        AddressModel mdl = new AddressModel();
        ...
        public AddressController()
        {
            msg = "";
            tblname = "tblAddress";
            ViewBag.Function_Title = "THÔNG TIN ĐỊA CHỈ";
            ViewBag.Function_Title_Short = "Address";
        ...
        public ActionResult Index(string id)
        {
            ...
            return View("~/Areas/Admin/Views/Address/Index.cshtml");
        }
