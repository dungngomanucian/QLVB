...
namespace RICTotalAdmin.Controllers
{
    public class EmailContactController:Controller
    {
        ...
        EmailContactModel mdl = new EmailContactModel();
        ...
        {
            msg = "";
            tblname = "tblEmailContact";
            ViewBag.Function_Title = "THÔNG TIN E-MAIL LIÊN HỆ";
            ViewBag.Function_Title_Short = "EmailContact";
        ...
        public ActionResult Index(string id)
        {
            ...
            ViewBag.Function_Title = "THÔNG TIN E-MAIL LIÊN HỆ";
            ViewBag.Function_Title_Short = "EmailContact";
            return View("~/Areas/Admin/Views/EmailContact/Index.cshtml");
        }
