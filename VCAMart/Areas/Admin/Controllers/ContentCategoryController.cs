...
namespace RICTotalAdmin.Controllers
{
    ...
    public class ContentCategoryController:Controller
    {
        ...
        ContentCategoryModel mdl = new ContentCategoryModel();
        ...
        public ActionResult Index(string id)
        {
            ...
            ViewBag.Function_Title = "DANH MỤC BÀI VIẾT";
            ViewBag.Function_Title_Short = "TinTuc";
            return View("~/Areas/Admin/Views/ContentCategory/Index.cshtml");
        }
