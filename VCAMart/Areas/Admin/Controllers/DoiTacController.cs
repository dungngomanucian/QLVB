...
namespace RICTotalAdmin.Controllers
{
    public class DoiTacController:Controller
    {
        ...
        DoiTacModel mdl = new DoiTacModel();
        ...
        public DoiTacController()
        {
            msg = "";
            tblname = "tblDoiTac";
            ViewBag.Function_Title = "DANH SÁCH ĐỐI TÁC";
            ViewBag.Function_Title_Short = "Doi Tac";
        ...
        public ActionResult Index(string id)
        {
            ...
            ViewBag.Function_Title = "DANH SÁCH ĐỐI TÁC";
            ViewBag.Function_Title_Short = "Doi Tac";
            return View("~/Areas/Admin/Views/DoiTac/Index.cshtml");
        }
