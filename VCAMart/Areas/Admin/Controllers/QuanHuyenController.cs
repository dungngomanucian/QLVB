...
namespace RICTotalAdmin.Controllers
{
    public class QuanHuyenController:Controller
    {
        ...
        QuanHuyenModel mdl = new QuanHuyenModel();
        ...
        {
            msg = "";
            tblname = "tblDistricts";
            ViewBag.Function_Title = "DANH MỤC QUẬN/HUYỆN";
            ViewBag.Function_Title_Short = "Quan huyen";
        ...
        public ActionResult Index(string id)
        {
            ...
            ViewBag.mn_tt = id;
            ViewBag.Function_Title = "THÔNG TIN ĐƠN VỊ";
            ViewBag.Function_Title_Short = "Part";
            return View("~/Areas/Admin/Views/QuanHuyen/Index.cshtml");
        }
        ...
        bool IsValid(ref dynamic data, bool bAdd = true)
        {
            ...
            if (data.TQ_Code == "") kt = false;
            if (data.TQ_Name == "") kt = false;
            return kt;
        }
