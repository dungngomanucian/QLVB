...
{
    public class DuyetThanhVienController:Controller
    {
        string msg = "";
        public string userId;
        jsonClientPost jc = new jsonClientPost();
        DuyetThanhVienModel mdl = new DuyetThanhVienModel();
        ...
        public DuyetThanhVienController()
        {
            msg = "";
            tblname = "tblMembers";
            ViewBag.Function_Title = "DANH SÁCH THANH VIÊN";
            ViewBag.Function_Title_Short = "Thanh vien";
        ...
        public ActionResult Index(string id)
        {
            ...
            ViewBag.Function_Title = "DANH SÁCH THANH VIÊN";
            ViewBag.Function_Title_Short = "Thanh vien";
            return View("~/Areas/Admin/Views/DuyetThanhVien/Index.cshtml");
        }

        public ActionResult GetList()
        {
            jc.data = mdl.GetList(userId);
            jc.msg = mdl.msg;
        ...
        public ActionResult GetBookGroup()
        {
            string data = mdl.GetBookGroup();
        ...
        bool IsValid(ref dynamic data, bool bAdd = true)
        {
            ...
            if (System.Web.HttpContext.Current.Session["lang_id"] == null ||System.Web.HttpContext.Current.Session["lang_id"].ToString() == "" )
                kt = false;
            return kt;
        }
