...
{
    [ValidateInput(false)]
    public class ContentArticlesByCatController:Controller
    {
        string msg = "";
        jsonClientPost jc = new jsonClientPost();
        ContentArticlesByCatModel mdl = new ContentArticlesByCatModel();
        ...
        public ContentArticlesByCatController()
        {
            msg = "";
            tblname = "tblContentArticles";
            
            ViewBag.Function_Title_Short = "TinTuc";
        ...
        public ActionResult Index(string id)
        {
            ...
            ViewBag.CatID = mdl.GetCategoryID(CategoryID);
            ViewBag.CatName = mdl.GetCategoryName(CategoryID);

            ViewBag.mn_tt = id;
            ViewBag.Function_Title = "CHUYÊN MỤC " + ViewBag.CatName.ToString();
            ViewBag.Function_Title_Short = "TinTuc";
            return View("~/Areas/Admin/Views/ContentArticlesByCat/Index.cshtml");
        }
        ...
        public ActionResult GetList(int pageSize = 20, int page = 1)
        {
            ...
            string data = mdl.GetList(pageSize.ToString(), page.ToString(), ref total, CategoryID);
        ...
        public ActionResult ListParent()
        {
            var nodes = mdl.GetCategoryTree();
            var data = mdl.BuildTreeDropdown(nodes, ContentArticlesByCatModel.ROOT_ID);
