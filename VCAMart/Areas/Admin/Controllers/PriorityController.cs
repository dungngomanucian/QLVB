...
namespace RICTotalAdmin.Controllers
{
    public class PriorityController:Controller
    {
        ...
        PriorityModel mdl = new PriorityModel();
        ...
        public PriorityController()
        {
            msg = "";
            tblname = "tblPriority";
            ViewBag.Function_Title = "DANH MỤC QUYỀN ƯU TIÊN";
            ViewBag.Function_Title_Short = "Priority";
        ...
        public ActionResult Index(string id)
        {
            ...
            ViewBag.Function_Title = "DANH MỤC QUYỀN ƯU TIÊN";
            ViewBag.Function_Title_Short = "Priority";
            return View("~/Areas/Admin/Views/Priority/Index.cshtml");
        }
