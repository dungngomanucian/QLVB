...
{
    public class ContentArticlesModel
    {
        ...
        public string GetList(string pageSize, string pageIndex, ref int total)
        {
           ...
           // return common.RunSQLToJson(sql,   ref msg);
            ...
            string msg = "";
            total = 0;
            string sql = "exec Admin.sp_tblContentArticles_Get_List_Page  " + pageSize + "," + pageIndex + ",0";// "exec [SDV_WorkerBasicInfor_Get_List]  " + page + "," + pageSize + "";
            DataTable dt;
        ...
        {
            string sql = "exec sp_" + tblname + "_Get_List_By_Cat " + id + "," + System.Web.HttpContext.Current.Session["lang_id"].ToString();
            return common.RunSQLToJson(sql, ref msg);
        }
