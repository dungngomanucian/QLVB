...
namespace RICTotalAdmin.Models
{
    public class Menu
    {
        ...
        {
            string sql = "exec Admin.sp_tblMenu_Get_List_Parent ";
            return common.RunSQLToJson(sql, ref msg);
            //return common.RunSQLToJsonManual(sql, ";MN_Parent_Name;MN_Id;MN_Ten;MN_Url;MN_Icon;MN_Thutu, active;", ref msg);
        }
        ...
        public bool Insert(dynamic row, string uid)
        {
         ...
         //   RICDB.DB.RunSQLNoReturn(sql, ref msg, strcnn);
           ...
           // string NQMN_Id = 
            ...
            cmd.Parameters.Add(new SqlParameter("@MN_System", 1));
            ...
            try
            {
                ...
                try
                {
                    ...
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        sql = "EXEC Admin.sp_tblNhomQuyen_Menu_Insert_Value N'" + groupid + "',N'" + MN_Id + "'";
                        RICDB.DB.RunSQLNoReturn(sql, ref msg, strcnn);
                    }
                }
                catch
