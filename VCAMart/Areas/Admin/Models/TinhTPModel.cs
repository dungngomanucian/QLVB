...
namespace RICTotalAdmin.Models
{
    public class TinhTPModel
    {
        ...
        public bool Insert(dynamic row, string uid)
        {
            ...
            if (objCommon.check_code("tblProvinces", "PR_Code", row.PR_Code.ToString()))
            {
            ...
            cmd.Parameters.Add(new SqlParameter("@PR_Id", row.id.ToString()));
          

            cmd.Parameters.Add(new SqlParameter("@PR_Code", row.PR_Code.ToString()));
            cmd.Parameters.Add(new SqlParameter("@PR_Name", row.PR_Name.ToString()));
            cmd.Parameters.Add(new SqlParameter("@PR_Status", row.active.ToString()));
            cmd.Parameters.Add(new SqlParameter("@PR_CreatedById", userId));
        ...
        public bool Update(dynamic row, string uid)
        {
            ...
            string New_Code = row.PR_Code.ToString().Trim();
            ...
            cmd.Parameters.Add(new SqlParameter("@PR_Name", row.PR_Name.ToString()));
            cmd.Parameters.Add(new SqlParameter("@PR_Status", row.active.ToString()));
            cmd.Parameters.Add(new SqlParameter("@PR_UpdatedById", userId));
