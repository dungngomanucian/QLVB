...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        LicenseName = "RIC";
        LicenseKey = "FWU1L2HFTAEDPFTBMN5418DRMGX3NAU5";
        string thumuc = "PF" + (Session["MB_uid"]==null?"NoLogin": Session["MB_uid"].ToString().Replace("-",""));
        // The base URL used to reach files in CKFinder through the browser.
        //BaseUrl = "/Images/" + thumuc +"/";
        // BaseDir = HttpContext.Current.Server.MapPath("~/Images/" + thumuc + "/");
         BaseUrl = "~/Images/" + System.Web.HttpContext.Current.Session["MB_uid"] + "/"; // "/Images/";
         BaseDir = HttpContext.Current.Server.MapPath("~/Images/" + System.Web.HttpContext.Current.Session["MB_uid"] + "/");

       // BaseUrl = "~/upload/";// + System.Web.HttpContext.Current.Session["user_uid"] + "/"; // "/Images/";
       // BaseDir = HttpContext.Current.Server.MapPath("~/upload/");// + System.Web.HttpContext.Current.Session["user_uid"] + "/");
        ...
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "7z", "aiff", "asf", "avi", "bmp", "csv", "doc", "docx", "fla", "flv", "gif", "gz", "gzip", "jpeg", "jpg", "mid", "mov", "mp3", "mp4", "mpc", "mpeg", "mpg", "ods", "odt", "pdf", "png", "ppt", "pptx", "pxd", "qt", "ram", "rar", "rm", "rmi", "rmvb", "rtf", "sdc", "sitd", "swf", "sxc", "sxw", "tar", "tgz", "tif", "tiff", "txt", "vsd", "wav", "wma", "wmv", "xls", "xlsx", "zip","json" };
        ...
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "bmp", "gif", "jpeg", "jpg", "png", "doc","docx","pdf","mp3","json" };
        type.DeniedExtensions = new string[] { };
        
        type = ResourceType.Add("JsonFiles");
        type.Url = BaseUrl + "json/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "json/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "json" };
        type.DeniedExtensions = new string[] { };
    }
