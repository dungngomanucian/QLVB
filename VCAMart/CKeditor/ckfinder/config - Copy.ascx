...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        string thumuc = "PF" + (Session["user_uid"]==null?"NoLogin": Session["user_uid"].ToString().Replace("-",""));
       ...
       // BaseDir = HttpContext.Current.Server.MapPath("~/upload/");// + System.Web.HttpContext.Current.Session["user_uid"] + "/");
        ...
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "bmp", "gif", "jpeg", "jpg", "png", "doc","docx","pdf","mp3" };
        type.DeniedExtensions = new string[] { };
